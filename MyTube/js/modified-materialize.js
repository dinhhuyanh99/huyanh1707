    ...
    _createClass(Modal, [{
      ...
      value: function handleOverlayClick() {
        if (this.options.dismissible) {
          this.close();
          // Added in 21 Sept 2017 to dissmiss every playing audio and video
      ...
      value: function animateIn() {
        ...
        // Animate overlay modified
        Vel(this.$overlay[0], { opacity: 0.80 }, { duration: this.options.inDuration, queue: false, ease: 'easeOutCubic' });
